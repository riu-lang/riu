...
class YuxLexer : LexerBase() {
    ...
    override fun advance() {
        ...
        if (c == ';') {
            ...
            tokenEnd = i
            tokenType = YuxTokenTypes.LINE_COMMENT
            return
        }
        ...
        if (c == '"') {
            ...
            tokenType = YuxTokenTypes.STRING
            return
        }
        ...
        if (c == 'c' && tokenStart + 1 < endOffset && buffer[tokenStart + 1] == '\'') {
            ...
            if (end > 0) {
                tokenEnd = end
                tokenType = YuxTokenTypes.CODE_POINT
                return
            }
            // 不是合法代码点，按标识符处理
        }
        ...
        if (c in '0'..'9') {
            ...
            tokenType = YuxTokenTypes.NUMBER
            return
        }
        ...
        tokenType = YuxTokenTypes.SYMBOL
    }
