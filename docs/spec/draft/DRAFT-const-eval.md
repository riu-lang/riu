...
作用：把"全局常量初始化器形态可写到什么程度 / 哪些 fn 算 const fn / struct 字面量能否进入常量上下文"这一组决策固化为单一规范，作为修改 `docs/spec/04-基础语法.md` `docs/spec/07-结构体.md` `docs/spec/11-编译期注解.md` 与 `CURRENT.md` 实施计划的依据。
