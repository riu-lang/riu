...
// _riu_global_init_<Mod>() 中 emit store 指令来运行期初始化。
//
...
#ifndef RIU_LANG_GLOBAL_VAR_NODE_H
#define RIU_LANG_GLOBAL_VAR_NODE_H
...
// ConstantValue 定义在 riu/include/constant_value.h（与 types.h 同级），
