...
// 编译器侧 ANTLR 错误监听器（0 LLVM）。parse 安装，放 ast。
//
...
#ifndef RIU_LANG_SYNTAX_ERROR_LISTENER_H
#define RIU_LANG_SYNTAX_ERROR_LISTENER_H
...
public:
    ...
    // 用于调用方构造 RiuError 时复现正确的错误码与行号（而非万能 E5010）。
...
#endif // RIU_LANG_SYNTAX_ERROR_LISTENER_H
