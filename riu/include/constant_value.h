...
// 层（ConstEvaluator）共享使用。与 types.h / error_code.h 同级置于 riu/include/。
//
...
#ifndef RIU_LANG_CONSTANT_VALUE_H
#define RIU_LANG_CONSTANT_VALUE_H
...
#endif // RIU_LANG_CONSTANT_VALUE_H
