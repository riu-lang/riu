...
DEF_ERR(5005, "riu.toml `lib` must be a table")
DEF_ERR(5006, "riu.toml `lib.type` must be \"static\" or \"dynamic\"")
DEF_ERR(5007, "riu.toml `lib.type=\"dynamic\"` not yet supported")
DEF_ERR(5008, "riu.toml `[lib]` and `entry` are mutually exclusive")
