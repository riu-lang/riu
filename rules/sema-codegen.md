...
- 泛型 fn/impl 体已走 SemaPass：类型参数当不透明 TypeParam。形态检查（#NoCopy / 未定义符号 / arity）在模板体报；ret / 赋值 / 方法分派 / 内置运算符 / 一元运算符 / 嵌套泛型推断在调用点或写出的 `S<Concrete>` 类型位置 `substitute` 后再查（E3014 / E3095 / E3001 / E3070 / E3071 / E3074 / E6012 / E6013）。
